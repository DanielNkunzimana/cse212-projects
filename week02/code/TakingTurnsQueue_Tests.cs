...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue was behaving like a stack (LIFO), so Bob/Tim/Sue came out reversed.
    ...
    // Defect(s) Found: Same LIFO bug in PersonQueue plus GetNextPerson failed to re‑enqueue players with 1 or 0 turns left.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Players with turns ≤ 0 were not treated as infinite; they were discarded after one turn.
    ...
    // Defect(s) Found:  Same infinite‑turn bug (turns ≤ 0).
    ...
    // Defect(s) Found: None – empty‑queue exception message was already correct.
